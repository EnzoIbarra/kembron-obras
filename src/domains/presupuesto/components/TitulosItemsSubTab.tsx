  ...
  return (
    <>
      <div className={`mt-2 grid grid-cols-3 gap-1 text-xs md:hidden ${cls}`}>
        <div><div className="text-gray-400 mb-0.5 font-normal">Teórico</div><div>{formatCurrency(theoretical)}</div></div>
        <div><div className="text-gray-400 mb-0.5 font-normal">Real</div><div>{formatCurrency(real)}</div></div>
        <div><div className="text-gray-400 mb-0.5 font-normal">Ejecutado</div><div>{formatCurrency(executed)}</div></div>
      </div>
      <div className={`hidden md:flex md:items-center md:justify-end text-sm px-4 ${cls}`}>{formatCurrency(theoretical)}</div>
      <div className={`hidden md:flex md:items-center md:justify-end text-sm px-4 ${cls}`}>{formatCurrency(real)}</div>
      <div className={`hidden md:flex md:items-center md:justify-end text-sm px-4 ${cls}`}>{formatCurrency(executed)}</div>
    </>
  );
}
